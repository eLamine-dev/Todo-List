...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n   margin: 0;\n   padding: 0;\n   box-sizing: border-box;\n}\n\n:root {\n   --darker: #0f172a;\n   --dark: #334155;\n   --medium: #64748b;\n   --light: #cbd5e1;\n   --lighter: #f1f5f9;\n   --red: #f87171;\n   --green: #0d9488;\n}\n\napp-page {\n   height: 90vh;\n   display: grid;\n   grid-template-columns: 2fr 7fr 2fr;\n   justify-items: stretch;\n   justify-content: space-between;\n}\n\ntask-list {\n   display: grid;\n}\n\ntask-card {\n   display: grid;\n   height: 10rem;\n   padding: 1rem;\n   border: #0f172a 1px solid;\n   border-radius: 1rem;\n}\n\nadd-task-form {\n   display: grid;\n}\n\nside-bar {\n   padding: 1.5rem;\n   display: grid;\n   grid-template-rows: 1fr 7fr;\n   gap: 3rem;\n}\n\nproject-list {\n   display: grid;\n   grid-template-columns: repeat(auto-fill, auto);\n   grid-auto-rows: auto;\n   gap: 0.2rem;\n   padding-left: 1rem;\n}\n\n.add-category-btn {\n   order: 1;\n}\n\n.item-title {\n   outline: none;\n}\n\n/* .item-title[contentEditable='true'] {\n   border: #0f172a 1px solid;\n} */\n\n.category {\n   position: relative;\n   cursor: pointer;\n   border: #0f172a solid 1px;\n}\n\n.addProjectBtn {\n   display: none;\n   position: absolute;\n   left: 100%;\n}\n\ncategory-list:hover .addProjectBtn {\n   display: block;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA;GACG,SAAS;GACT,UAAU;GACV,sBAAsB;AACzB;;AAEA;GACG,iBAAiB;GACjB,eAAe;GACf,iBAAiB;GACjB,gBAAgB;GAChB,kBAAkB;GAClB,cAAc;GACd,gBAAgB;AACnB;;AAEA;GACG,YAAY;GACZ,aAAa;GACb,kCAAkC;GAClC,sBAAsB;GACtB,8BAA8B;AACjC;;AAEA;GACG,aAAa;AAChB;;AAEA;GACG,aAAa;GACb,aAAa;GACb,aAAa;GACb,yBAAyB;GACzB,mBAAmB;AACtB;;AAEA;GACG,aAAa;AAChB;;AAEA;GACG,eAAe;GACf,aAAa;GACb,2BAA2B;GAC3B,SAAS;AACZ;;AAEA;GACG,aAAa;GACb,8CAA8C;GAC9C,oBAAoB;GACpB,WAAW;GACX,kBAAkB;AACrB;;AAEA;GACG,QAAQ;AACX;;AAEA;GACG,aAAa;AAChB;;AAEA;;GAEG;;AAEH;GACG,kBAAkB;GAClB,eAAe;GACf,yBAAyB;AAC5B;;AAEA;GACG,aAAa;GACb,kBAAkB;GAClB,UAAU;AACb;;AAEA;GACG,cAAc;AACjB","sourcesContent":["* {\n   margin: 0;\n   padding: 0;\n   box-sizing: border-box;\n}\n\n:root {\n   --darker: #0f172a;\n   --dark: #334155;\n   --medium: #64748b;\n   --light: #cbd5e1;\n   --lighter: #f1f5f9;\n   --red: #f87171;\n   --green: #0d9488;\n}\n\napp-page {\n   height: 90vh;\n   display: grid;\n   grid-template-columns: 2fr 7fr 2fr;\n   justify-items: stretch;\n   justify-content: space-between;\n}\n\ntask-list {\n   display: grid;\n}\n\ntask-card {\n   display: grid;\n   height: 10rem;\n   padding: 1rem;\n   border: #0f172a 1px solid;\n   border-radius: 1rem;\n}\n\nadd-task-form {\n   display: grid;\n}\n\nside-bar {\n   padding: 1.5rem;\n   display: grid;\n   grid-template-rows: 1fr 7fr;\n   gap: 3rem;\n}\n\nproject-list {\n   display: grid;\n   grid-template-columns: repeat(auto-fill, auto);\n   grid-auto-rows: auto;\n   gap: 0.2rem;\n   padding-left: 1rem;\n}\n\n.add-category-btn {\n   order: 1;\n}\n\n.item-title {\n   outline: none;\n}\n\n/* .item-title[contentEditable='true'] {\n   border: #0f172a 1px solid;\n} */\n\n.category {\n   position: relative;\n   cursor: pointer;\n   border: #0f172a solid 1px;\n}\n\n.addProjectBtn {\n   display: none;\n   position: absolute;\n   left: 100%;\n}\n\ncategory-list:hover .addProjectBtn {\n   display: block;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
class AppController {
   ...
   initializeListeners() {
      _utils_PubSub__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe('task:select', this.handleTaskSelect.bind(this));
   }
...
class ListItem extends HTMLElement {
   ...
   render() {
      const title = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('h6')
         .setContent('Add new...')
...
class ExpandableList extends HTMLElement {
   ...
   addItem() {
      ...
      const newItem = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('editable-li')
   ...
   addEventListeners() {
      this.addEventListener('click', (ev) => {
         if (ev.target.classList.contains('add-category-btn')) {
            this.createListForCategory(null, null);
...
class TaskCard extends HTMLElement {
   ...
   render() {
      ...
      const title = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('h3').setContent(this.state.title);
      const date = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('div').setContent(this.state.date);
      const project = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('div').setContent(
   ...
   addEventListeners() {
      this.addEventListener('click', (ev) => {
         ...
         if (ev.target.classList.contains('edit')) {
            _utils_PubSub__WEBPACK_IMPORTED_MODULE_1__["default"].publish('task:edit', this.state.id);
         }
      });
   }
}
...
class TaskDetails extends HTMLElement {
   ...
   render() {
      const title = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('h2')
         .setAttributes({
            type: 'text',
            name: 'title-input',
...
class AppPage extends HTMLElement {
   connectedCallback() {
      _utils_PubSub__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe('task:select', this.openTaskDetails.bind(this));
   }

   openTaskDetails(task) {
      if (document.getElementById('task-details')) this.lastChild.remove();
      const taskDetails = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_1__["default"])('task-details').setState(task);
