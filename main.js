...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n   margin: 0;\n   padding: 0;\n   box-sizing: border-box;\n   /* font-family: 'gg sans', sans-serif; */\n   /* font-family: 'gg sans Normal', sans-serif; */\n   font-family: 'gg sans Medium', sans-serif;\n   /* font-family: 'gg sans SemiBold', sans-serif; */\n}\n\n:root {\n   --darkest: #192332;\n   --darker: #1e293b;\n   --dark: #334155;\n   --medium: #475569;\n   --light: #64748b;\n   --lighter: #94a3b8;\n   --lightest: #cbd5e1;\n   --white: #f1f5f9;\n   --gray: #d1d5db;\n   --red: #f87171;\n   --green: #22c55e;\n   --blue: #3b82f6;\n   --blurple: #4f46e5;\n}\n\nbody {\n   overflow: hidden;\n}\n\napp-page {\n   display: grid;\n   grid-template-columns: minmax(250px, 1fr) 7fr;\n   grid-auto-flow: column;\n   grid-auto-columns: 3fr;\n   justify-items: stretch;\n   justify-content: stretch;\n   color: var(--white);\n   background-color: var(--darkest);\n}\n\ntask-list {\n   height: 100vh;\n   background-color: var(--darker);\n   display: grid;\n   grid-template-rows: 3rem;\n   grid-auto-rows: auto;\n   gap: 0.7rem;\n   justify-content: stretch;\n   justify-items: center;\n   align-content: start;\n   overflow: auto;\n   border-radius: 0 0.6rem 0.6rem 0;\n   padding: 0 0.5rem;\n   margin-right: 0.5rem;\n}\n\ntask-card {\n   width: min(100%, 900px);\n   display: grid;\n   grid-auto-flow: row;\n   grid-template-rows: max-content auto auto max-content;\n   height: 8rem;\n   padding: 0.5rem 1rem;\n   border-radius: 0.7rem;\n   background-color: var(--dark);\n   transition: 300ms;\n}\n\ntask-card:hover {\n   background-color: var(--medium);\n   cursor: pointer;\n   transform: translate(0, -2px);\n   box-shadow: 0 14px 28px rgba(0, 0, 0, 0.25), 0 10px 10px rgba(0, 0, 0, 0.22);\n}\n\ntask-card[editing] {\n   background-color: var(--medium);\n}\n\ntask-card .tags,\ntask-card .title-line,\ntask-card .buttons {\n   display: flex;\n   align-items: center;\n   justify-content: start;\n   gap: 0.5rem;\n}\n\ntask-card .tag {\n   font-size: 0.8rem;\n   border-radius: 1rem;\n   padding: 0.3rem 0.5rem;\n   width: max-content;\n   max-width: 8rem;\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n   background-color: var(--darker);\n}\n\ntask-card .tag i {\n   margin-right: 4px;\n}\n\ntask-card .tag[priority='1'] i {\n   color: red;\n}\n\ntask-card .tag[priority='2'] i {\n   color: yellow;\n}\n\ntask-card .tag[priority='3'] i {\n   color: green;\n}\n\ntask-card .tag[priority='4'] i {\n   color: blue;\n}\n\ntask-card .title {\n   font-size: 1.4rem;\n}\n\ntask-card .description {\n   color: var(--lightest);\n   font-family: 'gg sans Normal', sans-serif;\n   font-size: 1rem;\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n   align-self: flex-start;\n}\n\ntask-card .edit-btn,\ntask-card .delete,\ntask-card .checkbox-label {\n   cursor: pointer;\n   height: 1.6rem;\n   width: 2.6rem;\n   font-size: 1rem;\n   background-color: rgba(255, 255, 255, 0);\n   display: flex;\n   align-items: center;\n   justify-content: center;\n   border-radius: 0.7rem;\n}\n\ntask-card .edit-btn {\n   color: var(--light);\n}\n\n/* task-card .edit-btn:hover,\ntask-card[editing] .edit-btn {\n   color: var(--blurple);\n} */\n\ntask-card .delete {\n   color: var(--light);\n}\n\ntask-card .delete:hover,\ntask-card .checkbox-label[completed='true'],\ntask-card .checkbox-label:hover,\ntask-card .edit-btn:hover,\ntask-card[editing] .edit-btn {\n   /* color: var(--lighter); */\n   background-color: var(--dark);\n   border: var(--blurple) solid 1px;\n   filter: brightness(2);\n}\n\ntask-card .checkbox-label input {\n   position: absolute;\n   opacity: 0;\n   cursor: pointer;\n   height: 0;\n   width: 0;\n}\n\n.checkmark {\n   color: var(--light);\n   /* position: relative;\n   box-shadow: rgba(255, 85, 0, 0.478) 0px 0px 0px 2px;\n   background-color: rgba(16, 16, 16, 0.5);\n   height: 1rem;\n   width: 1rem;\n   flex-shrink: 0;\n   transition: all 0.2s ease 0s;\n   cursor: pointer;\n   transform-origin: 0px 10px;\n   border-radius: 4px;\n   padding: 0px;\n   box-sizing: content-box; */\n}\n\ntask-card .checkbox-label input:checked ~ .checkmark {\n   /* color: var(--green); */\n   /* box-shadow: rgb(255, 84, 0) 0px 0px 0px 2px;\n   background-color: rgba(245, 24, 24, 0.5); */\n}\n\n/* .checkmark:after {\n   content: '';\n   position: absolute;\n   opacity: 30%;\n} */\n\n/* task-card .checkbox-label input:checked ~ .checkmark:after {\n   opacity: 100%;\n} */\n\ntask-card .checkbox-label .checkmark:after {\n   left: 0.3em;\n   top: 0.1em;\n   width: 0.25em;\n   height: 0.5em;\n   border: solid white;\n   border-width: 0 0.15em 0.15em 0;\n   transform: rotate(45deg);\n   transition: all 500ms ease-in-out;\n}\n\ntask-card .status {\n   display: flex;\n   align-items: center;\n   width: max-content;\n   height: 1.8rem;\n   padding: 0 0.6rem;\n\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   border-radius: 1rem;\n}\n\ntask-card .status[status='completed'] {\n   /* background-color: var(--green); */\n   background: #2cc0531b;\n   border: var(--green) solid 1px;\n   color: var(--green);\n}\n\ntask-card .status[status='overdue'] {\n   /* background-color: var(--green); */\n   background: #c02c2c1b;\n   border: var(--red) solid 1px;\n   color: var(--red);\n}\n\ntask-card .status[status='pending'] {\n   /* background-color: var(--green); */\n   background: #422cc01b;\n   border: var(--blue) solid 1px;\n   color: var(--blue);\n}\n\n#new-task-form {\n   min-width: min(100%, 900px);\n   display: grid;\n   grid-template-columns: max-content auto;\n   align-items: center;\n   padding: 0.6rem;\n   border-radius: 0.7rem;\n   background-color: var(--dark);\n   column-gap: 1rem;\n}\n\ninput,\ntextarea,\nbutton {\n   outline: none;\n   border: none;\n}\n\nbutton {\n   display: flex;\n   align-items: center;\n   justify-content: center;\n   gap: 0.3rem;\n   cursor: pointer;\n}\n\ni {\n   pointer-events: none;\n}\n\n#new-task-form input,\n#new-task-form textarea {\n   padding: 0;\n   outline: none;\n   color: var(--white);\n   border: none;\n   background-color: var(--dark);\n}\n\n#new-task-form [name='title-input'] {\n   height: max-content;\n   font-size: 1.4rem;\n   font-family: 'gg sans medium', sans-serif;\n   justify-self: stretch;\n   grid-column: 2/3;\n}\n\n#new-task-form [name='description-input'] {\n   resize: none;\n   grid-column: 1/-1;\n   font-family: 'gg sans normal', sans-serif;\n}\n\n#new-task-form [name='save-task'] {\n   grid-row: 3/-1;\n}\n\n#new-task-form [name='save-task'],\n#new-task-form [name='open-form'],\ntask-details [name='save-task'] {\n   justify-self: flex-end;\n   color: var(--white);\n   border: none;\n   background-color: var(--blurple);\n   padding: 0 1rem;\n   height: 2.5rem;\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   border-radius: 1.2rem;\n}\n\n#new-task-form select,\n#new-task-form [name='date-input'] {\n   outline: none;\n   color: var(--white);\n   border: none;\n   background-color: var(--darker);\n   max-width: 10rem;\n   padding: 0 1rem;\n   height: 2rem;\n   border-radius: 0.5rem;\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n}\n\n#new-task-form .selection-inputs {\n   display: flex;\n   flex-wrap: wrap;\n   gap: 1rem;\n}\n\n#new-task-form[expanded='false'] .hidden-inputs {\n   display: none;\n}\n\n#new-task-form[expanded='true'] .hidden-inputs {\n   grid-column: 2/-1;\n   display: grid;\n\n   grid-template-rows: auto auto auto;\n   gap: 1rem;\n}\n\n#new-task-form .open-form {\n   grid-column: 3/4;\n}\n\n#new-task-form[expanded='true'] .open-form {\n   display: none;\n}\n\n#new-task-form[expanded='false'] .close-form {\n   display: none;\n}\n\n#new-task-form .close-form {\n   cursor: pointer;\n   color: var(--light);\n   background-color: rgba(255, 255, 255, 0);\n\n   font-size: 1.4rem;\n}\n\nside-bar {\n   height: 100vh;\n   display: grid;\n   grid-template-rows: 3rem 1fr 7fr;\n   gap: 3rem;\n   background-color: var(--dark);\n   overflow: auto;\n}\n\n.header {\n   z-index: 1;\n   position: sticky;\n   top: 0;\n   width: 100%;\n   display: flex;\n   align-items: center;\n   padding-left: 2rem;\n   justify-self: stretch;\n   border-bottom: var(--darkest) 1.5px solid;\n   background-color: inherit;\n}\n\nside-bar .default-filters-ul {\n   padding: 0 0.5rem;\n}\n\nproject-list {\n   width: 100%;\n   display: grid;\n   grid-template-rows: repeat(auto-fill, auto);\n   justify-content: stretch;\n   align-content: start;\n   padding: 0 0.5rem;\n   gap: 0.6rem;\n}\n\nproject-list exp-list {\n   display: flex;\n   flex-direction: row;\n   align-items: stretch;\n   overflow: hidden;\n}\n\nproject-list exp-list ul {\n   border-top: var(--light) solid 1px;\n   min-height: 2rem;\n   display: grid;\n   gap: 0.2rem;\n   overflow: hidden;\n   padding-left: 1rem;\n}\n\nproject-list editable-li,\n.default-filter {\n   font-size: 1rem;\n   display: flex;\n   align-items: center;\n\n   position: relative;\n   cursor: pointer;\n   height: 2rem;\n   padding: 0 0.4rem;\n   border-radius: 0.4rem;\n   gap: 0.3rem;\n   overflow: hidden;\n}\n\neditable-li .item-title {\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n}\n\neditable-li[active] {\n   background-color: var(--medium);\n   border: var(--gray) solid 1px;\n}\n\neditable-li input {\n   text-transform: capitalize;\n}\n\nside-bar [current-filter] {\n   background-color: var(--medium);\n}\n\nside-bar .default-filters-ul {\n   display: grid;\n   gap: 0.3rem;\n}\n\nside-bar editable-li:hover,\n.default-filter:hover {\n   background-color: var(--medium);\n}\n\neditable-li .item-buttons {\n   display: flex;\n   gap: 0.2rem;\n   opacity: 0;\n   position: absolute;\n   right: 4%;\n}\n\neditable-li[active] .item-buttons {\n   opacity: 1;\n}\n\neditable-li:hover .item-buttons {\n   opacity: 1;\n}\n\nproject-list exp-list [data-type='category']::before {\n   border-color: var(--lighter);\n   border-style: solid;\n   border-width: 0.15em 0.15em 0 0;\n   content: '';\n   display: inline-block;\n   height: 0.4em;\n   transform: rotate(45deg);\n   width: 0.4em;\n   margin-right: 0.2rem;\n}\n\nproject-list exp-list[expanded] [data-type='category']::before {\n   transform: rotate(135deg);\n}\n\nproject-list exp-list {\n   display: flex;\n   flex-direction: column;\n}\n\nproject-list .add-category-btn {\n   display: flex;\n   justify-content: start;\n\n   order: 1;\n   color: var(--lighter);\n   background-color: rgba(255, 255, 255, 0);\n   padding: 0 1rem;\n   height: 2rem;\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   border-radius: 0.4rem;\n   gap: 1rem;\n}\n\nproject-list .add-category-btn:hover {\n   background-color: var(--medium);\n   color: var(--lightest);\n}\n\nproject-list exp-list[expanded] .items-list {\n   display: block;\n}\n\nproject-list exp-list .items-list {\n   display: none;\n}\n\neditable-li .editing-input {\n   outline: none;\n   font-size: 1.1rem;\n   color: var(--lightest);\n   background-color: rgba(255, 255, 255, 0);\n   border-radius: 0.4rem;\n   width: 100%;\n   align-self: stretch;\n}\n\neditable-li[active].error {\n   background-color: var(--red);\n}\n\n[active].error {\n   -webkit-animation: shake 0.2s ease-in-out 0s 2;\n   animation: shake 0.2s ease-in-out 0s 2;\n}\n\neditable-li button {\n   font-size: 0.8rem;\n   height: 1.4rem;\n   width: 1.4rem;\n   border-radius: 0.2rem;\n   background-color: rgba(255, 255, 255, 0);\n   color: var(--gray);\n}\n\neditable-li button:hover {\n   background-color: var(--light);\n   filter: brightness(1.3);\n}\n\neditable-li .save-item,\neditable-li .cancel-editing {\n   display: none;\n}\n\neditable-li[active] .save-item,\neditable-li[active] .cancel-editing {\n   display: block;\n}\n\neditable-li[active] .edit-item,\neditable-li[active] .delete-item,\neditable-li[active] .item-title {\n   display: none;\n}\n\neditable-li .edit-item,\neditable-li .delete-item,\neditable-li .item-title {\n   display: block;\n}\n\n.checklist {\n   background-color: var(--darker);\n   display: grid;\n   grid-template-rows: repeat(auto-fill, auto);\n   align-content: start;\n   border-radius: 0.4rem;\n   padding: 1rem;\n}\n\n.checklist editable-li {\n   font-size: 1.1rem;\n   display: flex;\n   align-items: center;\n   position: relative;\n   cursor: pointer;\n   height: 2rem;\n   padding: 0 0.4rem;\n\n   border-radius: 0.4rem;\n}\n\n.checklist editable-li[data-type='checklist'] .edit-item,\n.checklist editable-li[data-type='checklist'] .delete-item {\n   display: none;\n}\n\n.checklist editable-li[data-type='checklist'] .item-buttons {\n   opacity: 1;\n}\n\n.checklist .list-header {\n   border-radius: 0;\n   border-bottom: var(--medium) solid 1px;\n}\n.checklist [data-type='checklist-item'][checked] {\n   text-decoration: line-through;\n}\n\n.checklist {\n   display: flex;\n   flex-direction: column;\n   gap: 1rem;\n   flex-basis: 100%;\n   min-height: 7rem;\n}\n\ntask-details {\n   height: 100vh;\n   z-index: 1;\n   display: grid;\n   min-width: 400px;\n   grid-template-rows: 3rem auto;\n   align-items: stretch;\n   background-color: var(--dark);\n   border-radius: 0.5rem;\n   align-content: start;\n   overflow: auto;\n   position: relative;\n}\n\ntask-details form {\n   display: flex;\n   flex-wrap: wrap;\n   justify-content: space-evenly;\n   align-content: center;\n   height: auto;\n   background-color: var(--dark);\n   padding: 2rem;\n   gap: 1rem;\n}\n\ntask-details form select,\ntask-details form [name='date-input'] {\n   outline: none;\n   color: var(--white);\n   border: none;\n   background-color: var(--darker);\n   max-width: 10rem;\n   padding: 0 1rem;\n   height: 2rem;\n   border-radius: 0.5rem;\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n}\n\ntask-details form [name='title-input'],\ntask-details form [name='description-input'] {\n   padding: 0;\n   outline: none;\n   color: var(--white);\n   border: none;\n   background-color: var(--dark);\n   flex-basis: 100%;\n}\n\ntask-details form [name='title-input'] {\n   font-size: 1.6rem;\n   font-family: 'gg sans medium', sans-serif;\n}\n\ntask-details form [name='description-input'] {\n   resize: none;\n   height: 7rem;\n   font-family: 'gg sans normal', sans-serif;\n}\n\ntask-details .header {\n   position: relative;\n   font-size: 1.4rem;\n}\n\ntask-details .close {\n   font-size: 1.5rem;\n   position: absolute;\n   right: 1.5rem;\n   color: var(--light);\n   background-color: rgba(255, 255, 255, 0);\n}\n\ntask-details [name='save-task'] {\n   position: absolute;\n   bottom: 10%;\n   right: 10%;\n}\n\n@-webkit-keyframes shake {\n   0% {\n   }\n   25% {\n      transform: translateX(1rem);\n   }\n   75% {\n      transform: translateX(-1rem);\n   }\n   100% {\n   }\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAEA;GACG,SAAS;GACT,UAAU;GACV,sBAAsB;GACtB,wCAAwC;GACxC,+CAA+C;GAC/C,yCAAyC;GACzC,iDAAiD;AACpD;;AAEA;GACG,kBAAkB;GAClB,iBAAiB;GACjB,eAAe;GACf,iBAAiB;GACjB,gBAAgB;GAChB,kBAAkB;GAClB,mBAAmB;GACnB,gBAAgB;GAChB,eAAe;GACf,cAAc;GACd,gBAAgB;GAChB,eAAe;GACf,kBAAkB;AACrB;;AAEA;GACG,gBAAgB;AACnB;;AAEA;GACG,aAAa;GACb,6CAA6C;GAC7C,sBAAsB;GACtB,sBAAsB;GACtB,sBAAsB;GACtB,wBAAwB;GACxB,mBAAmB;GACnB,gCAAgC;AACnC;;AAEA;GACG,aAAa;GACb,+BAA+B;GAC/B,aAAa;GACb,wBAAwB;GACxB,oBAAoB;GACpB,WAAW;GACX,wBAAwB;GACxB,qBAAqB;GACrB,oBAAoB;GACpB,cAAc;GACd,gCAAgC;GAChC,iBAAiB;GACjB,oBAAoB;AACvB;;AAEA;GACG,uBAAuB;GACvB,aAAa;GACb,mBAAmB;GACnB,qDAAqD;GACrD,YAAY;GACZ,oBAAoB;GACpB,qBAAqB;GACrB,6BAA6B;GAC7B,iBAAiB;AACpB;;AAEA;GACG,+BAA+B;GAC/B,eAAe;GACf,6BAA6B;GAC7B,4EAA4E;AAC/E;;AAEA;GACG,+BAA+B;AAClC;;AAEA;;;GAGG,aAAa;GACb,mBAAmB;GACnB,sBAAsB;GACtB,WAAW;AACd;;AAEA;GACG,iBAAiB;GACjB,mBAAmB;GACnB,sBAAsB;GACtB,kBAAkB;GAClB,eAAe;GACf,mBAAmB;GACnB,gBAAgB;GAChB,uBAAuB;GACvB,+BAA+B;AAClC;;AAEA;GACG,iBAAiB;AACpB;;AAEA;GACG,UAAU;AACb;;AAEA;GACG,aAAa;AAChB;;AAEA;GACG,YAAY;AACf;;AAEA;GACG,WAAW;AACd;;AAEA;GACG,iBAAiB;AACpB;;AAEA;GACG,sBAAsB;GACtB,yCAAyC;GACzC,eAAe;GACf,mBAAmB;GACnB,gBAAgB;GAChB,uBAAuB;GACvB,sBAAsB;AACzB;;AAEA;;;GAGG,eAAe;GACf,cAAc;GACd,aAAa;GACb,eAAe;GACf,wCAAwC;GACxC,aAAa;GACb,mBAAmB;GACnB,uBAAuB;GACvB,qBAAqB;AACxB;;AAEA;GACG,mBAAmB;AACtB;;AAEA;;;GAGG;;AAEH;GACG,mBAAmB;AACtB;;AAEA;;;;;GAKG,2BAA2B;GAC3B,6BAA6B;GAC7B,gCAAgC;GAChC,qBAAqB;AACxB;;AAEA;GACG,kBAAkB;GAClB,UAAU;GACV,eAAe;GACf,SAAS;GACT,QAAQ;AACX;;AAEA;GACG,mBAAmB;GACnB;;;;;;;;;;;6BAW0B;AAC7B;;AAEA;GACG,yBAAyB;GACzB;8CAC2C;AAC9C;;AAEA;;;;GAIG;;AAEH;;GAEG;;AAEH;GACG,WAAW;GACX,UAAU;GACV,aAAa;GACb,aAAa;GACb,mBAAmB;GACnB,+BAA+B;GAC/B,wBAAwB;GACxB,iCAAiC;AACpC;;AAEA;GACG,aAAa;GACb,mBAAmB;GACnB,kBAAkB;GAClB,cAAc;GACd,iBAAiB;;GAEjB,yCAAyC;GACzC,eAAe;GACf,mBAAmB;AACtB;;AAEA;GACG,oCAAoC;GACpC,qBAAqB;GACrB,8BAA8B;GAC9B,mBAAmB;AACtB;;AAEA;GACG,oCAAoC;GACpC,qBAAqB;GACrB,4BAA4B;GAC5B,iBAAiB;AACpB;;AAEA;GACG,oCAAoC;GACpC,qBAAqB;GACrB,6BAA6B;GAC7B,kBAAkB;AACrB;;AAEA;GACG,2BAA2B;GAC3B,aAAa;GACb,uCAAuC;GACvC,mBAAmB;GACnB,eAAe;GACf,qBAAqB;GACrB,6BAA6B;GAC7B,gBAAgB;AACnB;;AAEA;;;GAGG,aAAa;GACb,YAAY;AACf;;AAEA;GACG,aAAa;GACb,mBAAmB;GACnB,uBAAuB;GACvB,WAAW;GACX,eAAe;AAClB;;AAEA;GACG,oBAAoB;AACvB;;AAEA;;GAEG,UAAU;GACV,aAAa;GACb,mBAAmB;GACnB,YAAY;GACZ,6BAA6B;AAChC;;AAEA;GACG,mBAAmB;GACnB,iBAAiB;GACjB,yCAAyC;GACzC,qBAAqB;GACrB,gBAAgB;AACnB;;AAEA;GACG,YAAY;GACZ,iBAAiB;GACjB,yCAAyC;AAC5C;;AAEA;GACG,cAAc;AACjB;;AAEA;;;GAGG,sBAAsB;GACtB,mBAAmB;GACnB,YAAY;GACZ,gCAAgC;GAChC,eAAe;GACf,cAAc;GACd,yCAAyC;GACzC,eAAe;GACf,qBAAqB;AACxB;;AAEA;;GAEG,aAAa;GACb,mBAAmB;GACnB,YAAY;GACZ,+BAA+B;GAC/B,gBAAgB;GAChB,eAAe;GACf,YAAY;GACZ,qBAAqB;GACrB,yCAAyC;GACzC,eAAe;GACf,mBAAmB;GACnB,gBAAgB;GAChB,uBAAuB;AAC1B;;AAEA;GACG,aAAa;GACb,eAAe;GACf,SAAS;AACZ;;AAEA;GACG,aAAa;AAChB;;AAEA;GACG,iBAAiB;GACjB,aAAa;;GAEb,kCAAkC;GAClC,SAAS;AACZ;;AAEA;GACG,gBAAgB;AACnB;;AAEA;GACG,aAAa;AAChB;;AAEA;GACG,aAAa;AAChB;;AAEA;GACG,eAAe;GACf,mBAAmB;GACnB,wCAAwC;;GAExC,iBAAiB;AACpB;;AAEA;GACG,aAAa;GACb,aAAa;GACb,gCAAgC;GAChC,SAAS;GACT,6BAA6B;GAC7B,cAAc;AACjB;;AAEA;GACG,UAAU;GACV,gBAAgB;GAChB,MAAM;GACN,WAAW;GACX,aAAa;GACb,mBAAmB;GACnB,kBAAkB;GAClB,qBAAqB;GACrB,yCAAyC;GACzC,yBAAyB;AAC5B;;AAEA;GACG,iBAAiB;AACpB;;AAEA;GACG,WAAW;GACX,aAAa;GACb,2CAA2C;GAC3C,wBAAwB;GACxB,oBAAoB;GACpB,iBAAiB;GACjB,WAAW;AACd;;AAEA;GACG,aAAa;GACb,mBAAmB;GACnB,oBAAoB;GACpB,gBAAgB;AACnB;;AAEA;GACG,kCAAkC;GAClC,gBAAgB;GAChB,aAAa;GACb,WAAW;GACX,gBAAgB;GAChB,kBAAkB;AACrB;;AAEA;;GAEG,eAAe;GACf,aAAa;GACb,mBAAmB;;GAEnB,kBAAkB;GAClB,eAAe;GACf,YAAY;GACZ,iBAAiB;GACjB,qBAAqB;GACrB,WAAW;GACX,gBAAgB;AACnB;;AAEA;GACG,mBAAmB;GACnB,gBAAgB;GAChB,uBAAuB;AAC1B;;AAEA;GACG,+BAA+B;GAC/B,6BAA6B;AAChC;;AAEA;GACG,0BAA0B;AAC7B;;AAEA;GACG,+BAA+B;AAClC;;AAEA;GACG,aAAa;GACb,WAAW;AACd;;AAEA;;GAEG,+BAA+B;AAClC;;AAEA;GACG,aAAa;GACb,WAAW;GACX,UAAU;GACV,kBAAkB;GAClB,SAAS;AACZ;;AAEA;GACG,UAAU;AACb;;AAEA;GACG,UAAU;AACb;;AAEA;GACG,4BAA4B;GAC5B,mBAAmB;GACnB,+BAA+B;GAC/B,WAAW;GACX,qBAAqB;GACrB,aAAa;GACb,wBAAwB;GACxB,YAAY;GACZ,oBAAoB;AACvB;;AAEA;GACG,yBAAyB;AAC5B;;AAEA;GACG,aAAa;GACb,sBAAsB;AACzB;;AAEA;GACG,aAAa;GACb,sBAAsB;;GAEtB,QAAQ;GACR,qBAAqB;GACrB,wCAAwC;GACxC,eAAe;GACf,YAAY;GACZ,yCAAyC;GACzC,eAAe;GACf,qBAAqB;GACrB,SAAS;AACZ;;AAEA;GACG,+BAA+B;GAC/B,sBAAsB;AACzB;;AAEA;GACG,cAAc;AACjB;;AAEA;GACG,aAAa;AAChB;;AAEA;GACG,aAAa;GACb,iBAAiB;GACjB,sBAAsB;GACtB,wCAAwC;GACxC,qBAAqB;GACrB,WAAW;GACX,mBAAmB;AACtB;;AAEA;GACG,4BAA4B;AAC/B;;AAEA;GACG,8CAA8C;GAC9C,sCAAsC;AACzC;;AAEA;GACG,iBAAiB;GACjB,cAAc;GACd,aAAa;GACb,qBAAqB;GACrB,wCAAwC;GACxC,kBAAkB;AACrB;;AAEA;GACG,8BAA8B;GAC9B,uBAAuB;AAC1B;;AAEA;;GAEG,aAAa;AAChB;;AAEA;;GAEG,cAAc;AACjB;;AAEA;;;GAGG,aAAa;AAChB;;AAEA;;;GAGG,cAAc;AACjB;;AAEA;GACG,+BAA+B;GAC/B,aAAa;GACb,2CAA2C;GAC3C,oBAAoB;GACpB,qBAAqB;GACrB,aAAa;AAChB;;AAEA;GACG,iBAAiB;GACjB,aAAa;GACb,mBAAmB;GACnB,kBAAkB;GAClB,eAAe;GACf,YAAY;GACZ,iBAAiB;;GAEjB,qBAAqB;AACxB;;AAEA;;GAEG,aAAa;AAChB;;AAEA;GACG,UAAU;AACb;;AAEA;GACG,gBAAgB;GAChB,sCAAsC;AACzC;AACA;GACG,6BAA6B;AAChC;;AAEA;GACG,aAAa;GACb,sBAAsB;GACtB,SAAS;GACT,gBAAgB;GAChB,gBAAgB;AACnB;;AAEA;GACG,aAAa;GACb,UAAU;GACV,aAAa;GACb,gBAAgB;GAChB,6BAA6B;GAC7B,oBAAoB;GACpB,6BAA6B;GAC7B,qBAAqB;GACrB,oBAAoB;GACpB,cAAc;GACd,kBAAkB;AACrB;;AAEA;GACG,aAAa;GACb,eAAe;GACf,6BAA6B;GAC7B,qBAAqB;GACrB,YAAY;GACZ,6BAA6B;GAC7B,aAAa;GACb,SAAS;AACZ;;AAEA;;GAEG,aAAa;GACb,mBAAmB;GACnB,YAAY;GACZ,+BAA+B;GAC/B,gBAAgB;GAChB,eAAe;GACf,YAAY;GACZ,qBAAqB;GACrB,yCAAyC;GACzC,eAAe;GACf,mBAAmB;GACnB,gBAAgB;GAChB,uBAAuB;AAC1B;;AAEA;;GAEG,UAAU;GACV,aAAa;GACb,mBAAmB;GACnB,YAAY;GACZ,6BAA6B;GAC7B,gBAAgB;AACnB;;AAEA;GACG,iBAAiB;GACjB,yCAAyC;AAC5C;;AAEA;GACG,YAAY;GACZ,YAAY;GACZ,yCAAyC;AAC5C;;AAEA;GACG,kBAAkB;GAClB,iBAAiB;AACpB;;AAEA;GACG,iBAAiB;GACjB,kBAAkB;GAClB,aAAa;GACb,mBAAmB;GACnB,wCAAwC;AAC3C;;AAEA;GACG,kBAAkB;GAClB,WAAW;GACX,UAAU;AACb;;AAEA;GACG;GACA;GACA;MACG,2BAA2B;GAC9B;GACA;MACG,4BAA4B;GAC/B;GACA;GACA;AACH","sourcesContent":["@import url('https://fonts.cdnfonts.com/css/gg-sans-2');\n\n* {\n   margin: 0;\n   padding: 0;\n   box-sizing: border-box;\n   /* font-family: 'gg sans', sans-serif; */\n   /* font-family: 'gg sans Normal', sans-serif; */\n   font-family: 'gg sans Medium', sans-serif;\n   /* font-family: 'gg sans SemiBold', sans-serif; */\n}\n\n:root {\n   --darkest: #192332;\n   --darker: #1e293b;\n   --dark: #334155;\n   --medium: #475569;\n   --light: #64748b;\n   --lighter: #94a3b8;\n   --lightest: #cbd5e1;\n   --white: #f1f5f9;\n   --gray: #d1d5db;\n   --red: #f87171;\n   --green: #22c55e;\n   --blue: #3b82f6;\n   --blurple: #4f46e5;\n}\n\nbody {\n   overflow: hidden;\n}\n\napp-page {\n   display: grid;\n   grid-template-columns: minmax(250px, 1fr) 7fr;\n   grid-auto-flow: column;\n   grid-auto-columns: 3fr;\n   justify-items: stretch;\n   justify-content: stretch;\n   color: var(--white);\n   background-color: var(--darkest);\n}\n\ntask-list {\n   height: 100vh;\n   background-color: var(--darker);\n   display: grid;\n   grid-template-rows: 3rem;\n   grid-auto-rows: auto;\n   gap: 0.7rem;\n   justify-content: stretch;\n   justify-items: center;\n   align-content: start;\n   overflow: auto;\n   border-radius: 0 0.6rem 0.6rem 0;\n   padding: 0 0.5rem;\n   margin-right: 0.5rem;\n}\n\ntask-card {\n   width: min(100%, 900px);\n   display: grid;\n   grid-auto-flow: row;\n   grid-template-rows: max-content auto auto max-content;\n   height: 8rem;\n   padding: 0.5rem 1rem;\n   border-radius: 0.7rem;\n   background-color: var(--dark);\n   transition: 300ms;\n}\n\ntask-card:hover {\n   background-color: var(--medium);\n   cursor: pointer;\n   transform: translate(0, -2px);\n   box-shadow: 0 14px 28px rgba(0, 0, 0, 0.25), 0 10px 10px rgba(0, 0, 0, 0.22);\n}\n\ntask-card[editing] {\n   background-color: var(--medium);\n}\n\ntask-card .tags,\ntask-card .title-line,\ntask-card .buttons {\n   display: flex;\n   align-items: center;\n   justify-content: start;\n   gap: 0.5rem;\n}\n\ntask-card .tag {\n   font-size: 0.8rem;\n   border-radius: 1rem;\n   padding: 0.3rem 0.5rem;\n   width: max-content;\n   max-width: 8rem;\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n   background-color: var(--darker);\n}\n\ntask-card .tag i {\n   margin-right: 4px;\n}\n\ntask-card .tag[priority='1'] i {\n   color: red;\n}\n\ntask-card .tag[priority='2'] i {\n   color: yellow;\n}\n\ntask-card .tag[priority='3'] i {\n   color: green;\n}\n\ntask-card .tag[priority='4'] i {\n   color: blue;\n}\n\ntask-card .title {\n   font-size: 1.4rem;\n}\n\ntask-card .description {\n   color: var(--lightest);\n   font-family: 'gg sans Normal', sans-serif;\n   font-size: 1rem;\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n   align-self: flex-start;\n}\n\ntask-card .edit-btn,\ntask-card .delete,\ntask-card .checkbox-label {\n   cursor: pointer;\n   height: 1.6rem;\n   width: 2.6rem;\n   font-size: 1rem;\n   background-color: rgba(255, 255, 255, 0);\n   display: flex;\n   align-items: center;\n   justify-content: center;\n   border-radius: 0.7rem;\n}\n\ntask-card .edit-btn {\n   color: var(--light);\n}\n\n/* task-card .edit-btn:hover,\ntask-card[editing] .edit-btn {\n   color: var(--blurple);\n} */\n\ntask-card .delete {\n   color: var(--light);\n}\n\ntask-card .delete:hover,\ntask-card .checkbox-label[completed='true'],\ntask-card .checkbox-label:hover,\ntask-card .edit-btn:hover,\ntask-card[editing] .edit-btn {\n   /* color: var(--lighter); */\n   background-color: var(--dark);\n   border: var(--blurple) solid 1px;\n   filter: brightness(2);\n}\n\ntask-card .checkbox-label input {\n   position: absolute;\n   opacity: 0;\n   cursor: pointer;\n   height: 0;\n   width: 0;\n}\n\n.checkmark {\n   color: var(--light);\n   /* position: relative;\n   box-shadow: rgba(255, 85, 0, 0.478) 0px 0px 0px 2px;\n   background-color: rgba(16, 16, 16, 0.5);\n   height: 1rem;\n   width: 1rem;\n   flex-shrink: 0;\n   transition: all 0.2s ease 0s;\n   cursor: pointer;\n   transform-origin: 0px 10px;\n   border-radius: 4px;\n   padding: 0px;\n   box-sizing: content-box; */\n}\n\ntask-card .checkbox-label input:checked ~ .checkmark {\n   /* color: var(--green); */\n   /* box-shadow: rgb(255, 84, 0) 0px 0px 0px 2px;\n   background-color: rgba(245, 24, 24, 0.5); */\n}\n\n/* .checkmark:after {\n   content: '';\n   position: absolute;\n   opacity: 30%;\n} */\n\n/* task-card .checkbox-label input:checked ~ .checkmark:after {\n   opacity: 100%;\n} */\n\ntask-card .checkbox-label .checkmark:after {\n   left: 0.3em;\n   top: 0.1em;\n   width: 0.25em;\n   height: 0.5em;\n   border: solid white;\n   border-width: 0 0.15em 0.15em 0;\n   transform: rotate(45deg);\n   transition: all 500ms ease-in-out;\n}\n\ntask-card .status {\n   display: flex;\n   align-items: center;\n   width: max-content;\n   height: 1.8rem;\n   padding: 0 0.6rem;\n\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   border-radius: 1rem;\n}\n\ntask-card .status[status='completed'] {\n   /* background-color: var(--green); */\n   background: #2cc0531b;\n   border: var(--green) solid 1px;\n   color: var(--green);\n}\n\ntask-card .status[status='overdue'] {\n   /* background-color: var(--green); */\n   background: #c02c2c1b;\n   border: var(--red) solid 1px;\n   color: var(--red);\n}\n\ntask-card .status[status='pending'] {\n   /* background-color: var(--green); */\n   background: #422cc01b;\n   border: var(--blue) solid 1px;\n   color: var(--blue);\n}\n\n#new-task-form {\n   min-width: min(100%, 900px);\n   display: grid;\n   grid-template-columns: max-content auto;\n   align-items: center;\n   padding: 0.6rem;\n   border-radius: 0.7rem;\n   background-color: var(--dark);\n   column-gap: 1rem;\n}\n\ninput,\ntextarea,\nbutton {\n   outline: none;\n   border: none;\n}\n\nbutton {\n   display: flex;\n   align-items: center;\n   justify-content: center;\n   gap: 0.3rem;\n   cursor: pointer;\n}\n\ni {\n   pointer-events: none;\n}\n\n#new-task-form input,\n#new-task-form textarea {\n   padding: 0;\n   outline: none;\n   color: var(--white);\n   border: none;\n   background-color: var(--dark);\n}\n\n#new-task-form [name='title-input'] {\n   height: max-content;\n   font-size: 1.4rem;\n   font-family: 'gg sans medium', sans-serif;\n   justify-self: stretch;\n   grid-column: 2/3;\n}\n\n#new-task-form [name='description-input'] {\n   resize: none;\n   grid-column: 1/-1;\n   font-family: 'gg sans normal', sans-serif;\n}\n\n#new-task-form [name='save-task'] {\n   grid-row: 3/-1;\n}\n\n#new-task-form [name='save-task'],\n#new-task-form [name='open-form'],\ntask-details [name='save-task'] {\n   justify-self: flex-end;\n   color: var(--white);\n   border: none;\n   background-color: var(--blurple);\n   padding: 0 1rem;\n   height: 2.5rem;\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   border-radius: 1.2rem;\n}\n\n#new-task-form select,\n#new-task-form [name='date-input'] {\n   outline: none;\n   color: var(--white);\n   border: none;\n   background-color: var(--darker);\n   max-width: 10rem;\n   padding: 0 1rem;\n   height: 2rem;\n   border-radius: 0.5rem;\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n}\n\n#new-task-form .selection-inputs {\n   display: flex;\n   flex-wrap: wrap;\n   gap: 1rem;\n}\n\n#new-task-form[expanded='false'] .hidden-inputs {\n   display: none;\n}\n\n#new-task-form[expanded='true'] .hidden-inputs {\n   grid-column: 2/-1;\n   display: grid;\n\n   grid-template-rows: auto auto auto;\n   gap: 1rem;\n}\n\n#new-task-form .open-form {\n   grid-column: 3/4;\n}\n\n#new-task-form[expanded='true'] .open-form {\n   display: none;\n}\n\n#new-task-form[expanded='false'] .close-form {\n   display: none;\n}\n\n#new-task-form .close-form {\n   cursor: pointer;\n   color: var(--light);\n   background-color: rgba(255, 255, 255, 0);\n\n   font-size: 1.4rem;\n}\n\nside-bar {\n   height: 100vh;\n   display: grid;\n   grid-template-rows: 3rem 1fr 7fr;\n   gap: 3rem;\n   background-color: var(--dark);\n   overflow: auto;\n}\n\n.header {\n   z-index: 1;\n   position: sticky;\n   top: 0;\n   width: 100%;\n   display: flex;\n   align-items: center;\n   padding-left: 2rem;\n   justify-self: stretch;\n   border-bottom: var(--darkest) 1.5px solid;\n   background-color: inherit;\n}\n\nside-bar .default-filters-ul {\n   padding: 0 0.5rem;\n}\n\nproject-list {\n   width: 100%;\n   display: grid;\n   grid-template-rows: repeat(auto-fill, auto);\n   justify-content: stretch;\n   align-content: start;\n   padding: 0 0.5rem;\n   gap: 0.6rem;\n}\n\nproject-list exp-list {\n   display: flex;\n   flex-direction: row;\n   align-items: stretch;\n   overflow: hidden;\n}\n\nproject-list exp-list ul {\n   border-top: var(--light) solid 1px;\n   min-height: 2rem;\n   display: grid;\n   gap: 0.2rem;\n   overflow: hidden;\n   padding-left: 1rem;\n}\n\nproject-list editable-li,\n.default-filter {\n   font-size: 1rem;\n   display: flex;\n   align-items: center;\n\n   position: relative;\n   cursor: pointer;\n   height: 2rem;\n   padding: 0 0.4rem;\n   border-radius: 0.4rem;\n   gap: 0.3rem;\n   overflow: hidden;\n}\n\neditable-li .item-title {\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n}\n\neditable-li[active] {\n   background-color: var(--medium);\n   border: var(--gray) solid 1px;\n}\n\neditable-li input {\n   text-transform: capitalize;\n}\n\nside-bar [current-filter] {\n   background-color: var(--medium);\n}\n\nside-bar .default-filters-ul {\n   display: grid;\n   gap: 0.3rem;\n}\n\nside-bar editable-li:hover,\n.default-filter:hover {\n   background-color: var(--medium);\n}\n\neditable-li .item-buttons {\n   display: flex;\n   gap: 0.2rem;\n   opacity: 0;\n   position: absolute;\n   right: 4%;\n}\n\neditable-li[active] .item-buttons {\n   opacity: 1;\n}\n\neditable-li:hover .item-buttons {\n   opacity: 1;\n}\n\nproject-list exp-list [data-type='category']::before {\n   border-color: var(--lighter);\n   border-style: solid;\n   border-width: 0.15em 0.15em 0 0;\n   content: '';\n   display: inline-block;\n   height: 0.4em;\n   transform: rotate(45deg);\n   width: 0.4em;\n   margin-right: 0.2rem;\n}\n\nproject-list exp-list[expanded] [data-type='category']::before {\n   transform: rotate(135deg);\n}\n\nproject-list exp-list {\n   display: flex;\n   flex-direction: column;\n}\n\nproject-list .add-category-btn {\n   display: flex;\n   justify-content: start;\n\n   order: 1;\n   color: var(--lighter);\n   background-color: rgba(255, 255, 255, 0);\n   padding: 0 1rem;\n   height: 2rem;\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   border-radius: 0.4rem;\n   gap: 1rem;\n}\n\nproject-list .add-category-btn:hover {\n   background-color: var(--medium);\n   color: var(--lightest);\n}\n\nproject-list exp-list[expanded] .items-list {\n   display: block;\n}\n\nproject-list exp-list .items-list {\n   display: none;\n}\n\neditable-li .editing-input {\n   outline: none;\n   font-size: 1.1rem;\n   color: var(--lightest);\n   background-color: rgba(255, 255, 255, 0);\n   border-radius: 0.4rem;\n   width: 100%;\n   align-self: stretch;\n}\n\neditable-li[active].error {\n   background-color: var(--red);\n}\n\n[active].error {\n   -webkit-animation: shake 0.2s ease-in-out 0s 2;\n   animation: shake 0.2s ease-in-out 0s 2;\n}\n\neditable-li button {\n   font-size: 0.8rem;\n   height: 1.4rem;\n   width: 1.4rem;\n   border-radius: 0.2rem;\n   background-color: rgba(255, 255, 255, 0);\n   color: var(--gray);\n}\n\neditable-li button:hover {\n   background-color: var(--light);\n   filter: brightness(1.3);\n}\n\neditable-li .save-item,\neditable-li .cancel-editing {\n   display: none;\n}\n\neditable-li[active] .save-item,\neditable-li[active] .cancel-editing {\n   display: block;\n}\n\neditable-li[active] .edit-item,\neditable-li[active] .delete-item,\neditable-li[active] .item-title {\n   display: none;\n}\n\neditable-li .edit-item,\neditable-li .delete-item,\neditable-li .item-title {\n   display: block;\n}\n\n.checklist {\n   background-color: var(--darker);\n   display: grid;\n   grid-template-rows: repeat(auto-fill, auto);\n   align-content: start;\n   border-radius: 0.4rem;\n   padding: 1rem;\n}\n\n.checklist editable-li {\n   font-size: 1.1rem;\n   display: flex;\n   align-items: center;\n   position: relative;\n   cursor: pointer;\n   height: 2rem;\n   padding: 0 0.4rem;\n\n   border-radius: 0.4rem;\n}\n\n.checklist editable-li[data-type='checklist'] .edit-item,\n.checklist editable-li[data-type='checklist'] .delete-item {\n   display: none;\n}\n\n.checklist editable-li[data-type='checklist'] .item-buttons {\n   opacity: 1;\n}\n\n.checklist .list-header {\n   border-radius: 0;\n   border-bottom: var(--medium) solid 1px;\n}\n.checklist [data-type='checklist-item'][checked] {\n   text-decoration: line-through;\n}\n\n.checklist {\n   display: flex;\n   flex-direction: column;\n   gap: 1rem;\n   flex-basis: 100%;\n   min-height: 7rem;\n}\n\ntask-details {\n   height: 100vh;\n   z-index: 1;\n   display: grid;\n   min-width: 400px;\n   grid-template-rows: 3rem auto;\n   align-items: stretch;\n   background-color: var(--dark);\n   border-radius: 0.5rem;\n   align-content: start;\n   overflow: auto;\n   position: relative;\n}\n\ntask-details form {\n   display: flex;\n   flex-wrap: wrap;\n   justify-content: space-evenly;\n   align-content: center;\n   height: auto;\n   background-color: var(--dark);\n   padding: 2rem;\n   gap: 1rem;\n}\n\ntask-details form select,\ntask-details form [name='date-input'] {\n   outline: none;\n   color: var(--white);\n   border: none;\n   background-color: var(--darker);\n   max-width: 10rem;\n   padding: 0 1rem;\n   height: 2rem;\n   border-radius: 0.5rem;\n   font-family: 'gg sans Medium', sans-serif;\n   font-size: 1rem;\n   white-space: nowrap;\n   overflow: hidden;\n   text-overflow: ellipsis;\n}\n\ntask-details form [name='title-input'],\ntask-details form [name='description-input'] {\n   padding: 0;\n   outline: none;\n   color: var(--white);\n   border: none;\n   background-color: var(--dark);\n   flex-basis: 100%;\n}\n\ntask-details form [name='title-input'] {\n   font-size: 1.6rem;\n   font-family: 'gg sans medium', sans-serif;\n}\n\ntask-details form [name='description-input'] {\n   resize: none;\n   height: 7rem;\n   font-family: 'gg sans normal', sans-serif;\n}\n\ntask-details .header {\n   position: relative;\n   font-size: 1.4rem;\n}\n\ntask-details .close {\n   font-size: 1.5rem;\n   position: absolute;\n   right: 1.5rem;\n   color: var(--light);\n   background-color: rgba(255, 255, 255, 0);\n}\n\ntask-details [name='save-task'] {\n   position: absolute;\n   bottom: 10%;\n   right: 10%;\n}\n\n@-webkit-keyframes shake {\n   0% {\n   }\n   25% {\n      transform: translateX(1rem);\n   }\n   75% {\n      transform: translateX(-1rem);\n   }\n   100% {\n   }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
function initializeApp() {
   ...
   const taskController = new _controllers_TaskController__WEBPACK_IMPORTED_MODULE_0__["default"](taskModel, taskList, filter);
...
class ProjectController {
   ...
   handleDeleteProject(projectLi) {
      ...
      if (projectLi.hasAttribute('current-filter')) {
         _utils_PubSub__WEBPACK_IMPORTED_MODULE_0__["default"].publish('filter:changed', {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isEqual/index.js");
...

   {
      ...
      filter: function filter(tasks, date) {
         return tasks.filter((task) =>
            (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(task.date), new Date(date))
         );
      },
   },
...
/* harmony import */ var _utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/ElementBuilder */ "./src/utils/ElementBuilder.js");
/* harmony import */ var _utils_PubSub__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/PubSub */ "./src/utils/PubSub.js");
/* harmony import */ var _EditableListItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./EditableListItem */ "./src/views/components/EditableListItem.js");
...
class ExpandableList extends HTMLElement {
   ...
   render() {
      const listHeader = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('editable-li')
         .setState(this.state.header)
         .setAttributes({
            class: 'list-header',
         });

      const listUl = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('ul').setAttributes({
      ...
      if (this.state.items.list) {
         this.state.items.list.forEach((item) => {
            const itemLI = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('editable-li').setState(item);
      ...
      const addItemBtn = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('button')
         .setAttributes({
            class: 'add-item',
         })
   ...
   addItem() {
      ...
      const newItem = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('editable-li').setState({
         dataType: itemType,
      });
...
class ProjectList extends HTMLElement {
   ...
   render() {
      ...
      const header = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_0__["default"])('h3').setContent('Projects');
      this.prepend(header);
...
class SideBar extends HTMLElement {
   ...
   render() {
      ...
      const defaultFilters = [
         ...
         { id: 'today', type: 'date', value: (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(today, 'yyyy-MM-dd') },
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _TaskCard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TaskCard */ "./src/views/components/TaskCard.js");
/* harmony import */ var _utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/ElementBuilder */ "./src/utils/ElementBuilder.js");
/* harmony import */ var _AddTaskForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AddTaskForm */ "./src/views/components/AddTaskForm.js");
...
class TaskList extends HTMLElement {
   ...
   render() {
      const addTaskForm = new _AddTaskForm__WEBPACK_IMPORTED_MODULE_2__["default"]({
      ...
      const header = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_1__["default"])('header')
         .setContent('ToDo')
         .setAttributes({ class: 'header' })
         .prependTo(this);
   }
   ...
   makeTaskCard(task) {
      ...
      const newCard = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_1__["default"])('task-card').setState(task);
...
/* harmony import */ var _utils_PubSub__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/PubSub */ "./src/utils/PubSub.js");
/* harmony import */ var _utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/ElementBuilder */ "./src/utils/ElementBuilder.js");
/* harmony import */ var _components_TaskDetails__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/TaskDetails */ "./src/views/components/TaskDetails.js");
...
class AppPage extends HTMLElement {
   openTaskDetails(taskEditState) {
      ...
      const taskDetails = (0,_utils_ElementBuilder__WEBPACK_IMPORTED_MODULE_1__["default"])('task-details')
